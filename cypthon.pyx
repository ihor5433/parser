...
cpdef char create_table_and_header(
    char name_table, create_table=True,circle=True
):
...
cdef insert_into_table_value(annualTable, quarterlyTable, name):
